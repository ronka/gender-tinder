...
const hebrewNumbers:HebrewNumbers = {
	...
	28: { m: "עשרים ושמונה", f: "עשרים ושמונה" },
	29: { m: "עשרים ותשעה", f: "עשרים ותשע" },
	30: { m: "שלושים", f: "שלושים" },
	...
	38: { m: "שלושים ושמונה", f: "שלושים ושמונה" },
	39: { m: "שלושים ותשעה", f: "שלושים ותשע" },
	40: { m: "ארבעים", f: "ארבעים" },
	...
	48: { m: "ארבעים ושמונה", f: "ארבעים ושמונה" },
	49: { m: "ארבעים ותשעה", f: "ארבעים ותשע" },
	50: { m: "חמישים", f: "חמישים" },
	...
	58: { m: "חמישים ושמונה", f: "חמישים ושמונה" },
